...
import Features from "components/services/marketing/Features";
import Header from "components/services/marketing/Header";
import TechStack from "components/services/marketing/TechStack";
                        ...
                        <div className="mx-auto max-w-7xl px-8">
                            <div className="py-12 px-4 sm:px-6 md:flex md:flex-col md:py-8">
                                ...
                                <div className="relative text-lg font-medium text-black md:flex-grow">
                                    ...
                                    ¡Contáctanos hoy mismo y descubre cómo nuestro servicio de marketing puede impulsar tu marca al siguiente nivel y generar un impacto duradero en tu mercado objetivo!
                                    </p>
                                </div>
