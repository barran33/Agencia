...
import Features from "components/services/ciber_security/Features";
import Header from "components/services/ciber_security/Header";
import TechStack from "components/services/ciber_security/TechStack";
import OurClients from "components/services/ciber_security/OurClients";
                        ...
                        <div className="mx-auto max-w-7xl px-8">
                            <div className="py-12 px-4 sm:px-6 md:flex md:flex-col md:py-8">
                                ...
                                <div className="relative text-lg font-medium text-black md:flex-grow">
                                    ...
                                    <p className="relative text-cyan-400 mx-auto ">
                                    'No arriesgues la seguridad de tu empresa. ¡Contáctanos hoy mismo y descubre cómo nuestros servicios de ciberseguridad pueden mantener tus activos digitales seguros y tu negocio protegido en el mundo en línea en constante cambio...!!!'
                                    </p>
                                </div>
                                <footer className="mt-8">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <div className="text-base font-medium text-cyan-500">Founder & CEO, Co§mic Imagination</div>
                                    </div>
                                    </div>
                                </footer>
                                </blockquote>
