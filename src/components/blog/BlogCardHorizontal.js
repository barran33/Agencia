                ...
                <div className="flex items-center  my-10 ">
                  <div className="lg:flex min-w-0 lg:flex-1 items-center">
                    ...
                    <div className="lg:absolute lg:top-28">
                        ...
                        <span className=" hover:text-cyan-500  mx-1 font-medium text-gray-800 text-sm "><Link to={`/category/${data.category.slug}`}>{data.category.name}</Link></span> <span className="text-gray-300">&middot;</span> 
                        ...
                        <p className="mt-4 text-lg font-regular text-gray-800 leading-8">{data.description.length > 300 ? data.description.slice(0,149):data.description}</p>
                    </div>
                  </div>
                </div>
                </div>
